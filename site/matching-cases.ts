...
class MatchingCases extends LitElement {
  ...
  public render(): TemplateResult {
    return html`
      ...
      <h2 class="mdc-typography--headline3">Matching cases for route paths</h2>

      <p></p>

      <h3 id="text-path" class="mdc-typography--headline4">Text path</h3>
      ...
      <h3 id="path-with-variables" class="mdc-typography--headline4">Path with variables</h3>
